...
password-authenticated secure channel protocol by Wu [1]. In combination with an
...
computation time. We presented this in our MoMM2014 paper [2].
...
[1] T. Wu, "SRP-6: Improvements and Refinements to the Secure Remote Password Protocol," http://srp.stanford.edu/, Okt-2002. [Online]. Available: http://srp.stanford.edu/.
